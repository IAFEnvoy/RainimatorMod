...
public class FractionComponent implements ComponentV3, AutoSyncedComponent {
    public static final ComponentKey<FractionComponent> FRACTION_COMPONENT = ComponentRegistryV3.INSTANCE.getOrCreate(Identifier.of(RainimatorMod.MOD_ID, "fraction"), FractionComponent.class);
