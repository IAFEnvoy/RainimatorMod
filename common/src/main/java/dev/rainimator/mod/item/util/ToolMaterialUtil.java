...
public class ToolMaterialUtil {
    @SafeVarargs
    public static ToolMaterial of(int uses, float speed, float attackDamageBonus, int level, int enchantmentLevel, Supplier<? extends ItemConvertible>... repairIngredients) {
