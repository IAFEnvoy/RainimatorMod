...
public class ChiefOfThePigPeopleArmorItem extends ArmorWithTickItem {
    public ChiefOfThePigPeopleArmorItem(EquipmentSlot slot) {
        super(ArmorMaterialUtil.of("chief_of_the_pig_people_armors", new int[]{13, 15, 16, 11}, 25, new int[]{5, 10, 12, 5}, 10, Registry.SOUND_EVENT.get(Identifier.tryParse("item.armor.equip_diamond")), 3.0F, 0F, () -> Items.NETHERITE_INGOT), slot, new Settings().group(RainimatorItemGroups.MAIN));
    }
