...
public class RainimatorItems {
    ...
    //entity
    public static final RegistrySupplier<Item> HEROBRINE_SPAWN_EGG = register("herobrine_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.HEROBRINE, -10092544, -65536, new Item.Settings()));
    public static final RegistrySupplier<Item> CERIS_SPAWN_EGG = register("ceris_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.CERIS, -10092442, -65281, new Item.Settings()));
    public static final RegistrySupplier<Item> ZOMBIES_SPAWN_EGG = register("zombies_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.ZOMBIES, -16724941, -16751104, new Item.Settings()));
    public static final RegistrySupplier<Item> NAEUS_SPAWN_EGG = register("naeus_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.NAEUS, -10066330, -3355444, new Item.Settings()));
    public static final RegistrySupplier<Item> RAIN_SPAWN_EGG = register("rain_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.RAIN, -16777063, -13408513, new Item.Settings()));
    public static final RegistrySupplier<Item> ABIGAIL_SPAWN_EGG = register("abigail_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.ABIGAIL, -65332, -39169, new Item.Settings()));
    public static final RegistrySupplier<Item> PATRICK_SPAWN_EGG = register("patrick_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.PATRICK, -16737895, -13369345, new Item.Settings()));
    public static final RegistrySupplier<Item> BLACKBONE_SPAWN_EGG = register("blackbone_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.BLACKBONE, -16777216, -10066330, new Item.Settings()));
    public static final RegistrySupplier<Item> HOGSWORTH_SPAWN_EGG = register("hogsworth_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.HOGSWORTH, -26215, -13108, new Item.Settings()));
    public static final RegistrySupplier<Item> CIARA_SPAWN_EGG = register("ciara_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.CIARA, -52378, -39220, new Item.Settings()));
    public static final RegistrySupplier<Item> HILDA_SPAWN_EGG = register("hilda_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.HILDA, -256, -3355444, new Item.Settings()));
    public static final RegistrySupplier<Item> SOLDIERS_SPAWN_EGG = register("soldiers_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.SOLDIERS, -1, -1, new Item.Settings()));
    public static final RegistrySupplier<Item> WITHERED_SKELETONS_SPAWN_EGG = register("withered_skeletons_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.WITHERED_SKELETONS, -13421773, -10066330, new Item.Settings()));
    public static final RegistrySupplier<Item> DARK_SHIELD_SPAWN_EGG = register("dark_shield_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.DARK_SHIELD, -6736897, -16777216, new Item.Settings()));
    public static final RegistrySupplier<Item> DARK_ZOMBIE_SPAWN_EGG = register("dark_zombie_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.DARK_ZOMBIE, -16751104, -13369549, new Item.Settings()));
    public static final RegistrySupplier<Item> VORDUS_SPAWN_EGG = register("vordus_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.VORDUS, -13421773, -3355648, new Item.Settings()));
    public static final RegistrySupplier<Item> WITHER_SHIELD_SPAWN_EGG = register("wither_shield_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.WITHER_SHIELD, -16777216, -1, new Item.Settings()));
    public static final RegistrySupplier<Item> SKELETON_SNOW_SPAWN_EGG = register("skeleton_snow_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.SKELETON_SNOW, -1, -13369345, new Item.Settings()));
    public static final RegistrySupplier<Item> ZOMBIES_PIGLIN_KING_SPAWN_EGG = register("zombies_piglin_king_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.ZOMBIE_PIGLIN_KING, -39424, -256, new Item.Settings()));
    public static final RegistrySupplier<Item> PIGLIN_KING_ZOMBIES_SPAWN_EGG = register("piglin_king_zombies_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.PIGLIN_KING_ZOMBIES, -26368, -52, new Item.Settings()));
    public static final RegistrySupplier<Item> PIGLIN_KING_ZOMBIE_SPAWN_EGG = register("piglin_king_zombie_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.PIGLIN_KING_ZOMBIE, -256, -13108, new Item.Settings()));
    public static final RegistrySupplier<Item> PIGLIN_COMMANDER_SPAWN_EGG = register("piglin_commander_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.PIGLIN_COMMANDER, -52, -256, new Item.Settings()));
    public static final RegistrySupplier<Item> NAEUS_KING_SPAWN_EGG = register("naeus_king_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.NAEUS_KING, -6737152, -65536, new Item.Settings()));
    public static final RegistrySupplier<Item> TUSK_SPAWN_EGG = register("tusk_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.TUSK, -13159, -13108, new Item.Settings()));
    public static final RegistrySupplier<Item> BROTS_SPAWN_EGG = register("brots_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.BROTS, -3399168, -9175040, new Item.Settings()));
    public static final RegistrySupplier<Item> ZOMBIE_PIGLIN_ART_SPAWN_EGG = register("zombie_piglin_art_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.ZOMBIE_PIGLIN_ART, -1343393, -412045, new Item.Settings()));
    public static final RegistrySupplier<Item> MUTATED_SPAWN_EGG = register("mutated_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.MUTATED, -5134336, -16735132, new Item.Settings()));
    public static final RegistrySupplier<Item> NAMTAR_SPAWN_EGG = register("namtar_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.NAMTAR, -7274496, -12544, new Item.Settings()));
    public static final RegistrySupplier<Item> AGETHA_SPAWN_EGG = register("agetha_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.AGETHA, -6710887, -3381760, new Item.Settings()));
    public static final RegistrySupplier<Item> TRICER_SPAWN_EGG = register("tricer_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.TRICER, -3407872, -16777216, new Item.Settings()));
    public static final RegistrySupplier<Item> BIG_UNDEAD_SKELETON_SPAWN_EGG = register("big_undead_skeleton_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.BIG_UNDEAD_SKELETON, -10066330, -16777216, new Item.Settings()));
    public static final RegistrySupplier<Item> ARCHER_SPAWN_EGG = register("archer_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.ARCHER, -6710887, -16750951, new Item.Settings()));
    public static final RegistrySupplier<Item> DARYLL_SPAWN_EGG = register("daryll_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.DARYLL, -6737152, -1, new Item.Settings()));
    public static final RegistrySupplier<Item> NULL_LIKE_SPAWN_EGG = register("null_like_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.NULL_LIKE, -1, -16777216, new Item.Settings()));
    public static final RegistrySupplier<Item> GIGABONE_SPAWN_EGG = register("gigabone_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.GIGABONE, -10066330, -3355393, new Item.Settings()));
    public static final RegistrySupplier<Item> KLAUS_SPAWN_EGG = register("klaus_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.KLAUS, -10066432, -16764109, new Item.Settings()));
    public static final RegistrySupplier<Item> KLAUS_2_SPAWN_EGG = register("klaus_2_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.KLAUS_2, -6711040, -16751002, new Item.Settings()));
    public static final RegistrySupplier<Item> KRALOS_SPAWN_EGG = register("kralos_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.KRALOS, -16777165, -6750157, new Item.Settings()));
    public static final RegistrySupplier<Item> ARABELLA_SPAWN_EGG = register("arabella_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.ARABELLA, -3407668, -13369345, new Item.Settings()));
    public static final RegistrySupplier<Item> AZALEA_SPAWN_EGG = register("azalea_spawn_egg", () -> new ArchitecturySpawnEggItem(RainimatorEntities.AZALEA, -256, -16738048, new Item.Settings()));
