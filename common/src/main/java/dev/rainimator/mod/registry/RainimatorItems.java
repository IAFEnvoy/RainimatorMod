...
public class RainimatorItems {
    ...
    public static final RegistrySupplier<Item> HEROBRINE_SPAWN_EGG = register("herobrine_spawn_egg", () -> new SpawnEggBase(Episode.TheStruggle, RainimatorEntities.HEROBRINE.get(), -10092544, -65536));
    public static final RegistrySupplier<Item> CERIS_SPAWN_EGG = register("ceris_spawn_egg", () -> new SpawnEggBase(Episode.ColdAsIce, RainimatorEntities.CERIS.get(), -10092442, -65281));
    public static final RegistrySupplier<Item> ZOMBIES_SPAWN_EGG = register("zombies_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.ZOMBIES.get(), -16724941, -16751104));
    public static final RegistrySupplier<Item> NAEUS_SPAWN_EGG = register("naeus_spawn_egg", () -> new SpawnEggBase(Episode.BeginAgain, RainimatorEntities.NAEUS.get(), -10066330, -3355444));
    public static final RegistrySupplier<Item> RAIN_SPAWN_EGG = register("rain_spawn_egg", () -> new SpawnEggBase(Episode.TheStruggle, RainimatorEntities.RAIN.get(), -16777063, -13408513));
    public static final RegistrySupplier<Item> ABIGAIL_SPAWN_EGG = register("abigail_spawn_egg", () -> new SpawnEggBase(Episode.BeginAgain, RainimatorEntities.ABIGAIL.get(), -65332, -39169));
    public static final RegistrySupplier<Item> PATRICK_SPAWN_EGG = register("patrick_spawn_egg", () -> new SpawnEggBase(Episode.ColdAsIce, RainimatorEntities.PATRICK.get(), -16737895, -13369345));
    public static final RegistrySupplier<Item> BLACKBONE_SPAWN_EGG = register("blackbone_spawn_egg", () -> new SpawnEggBase(Episode.WeAreTheDanger, RainimatorEntities.BLACKBONE.get(), -16777216, -10066330));
    public static final RegistrySupplier<Item> HOGSWORTH_SPAWN_EGG = register("hogsworth_spawn_egg", () -> new SpawnEggBase(Episode.HardPillToSwallow, RainimatorEntities.HOGSWORTH.get(), -26215, -13108));
    public static final RegistrySupplier<Item> CIARA_SPAWN_EGG = register("ciara_spawn_egg", () -> new SpawnEggBase(Episode.Nightmares, RainimatorEntities.CIARA.get(), -52378, -39220));
    public static final RegistrySupplier<Item> HILDA_SPAWN_EGG = register("hilda_spawn_egg", () -> new SpawnEggBase(Episode.ColdAsIceRemake, RainimatorEntities.HILDA.get(), -256, -3355444));
    public static final RegistrySupplier<Item> SOLDIERS_SPAWN_EGG = register("soldiers_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.SOLDIERS.get(), -1, -1));
    public static final RegistrySupplier<Item> WITHERED_SKELETONS_SPAWN_EGG = register("withered_skeletons_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.WITHERED_SKELETONS.get(), -13421773, -10066330));
    public static final RegistrySupplier<Item> DARK_SHIELD_SPAWN_EGG = register("dark_shield_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.DARK_SHIELD.get(), -6736897, -16777216));
    public static final RegistrySupplier<Item> DARK_ZOMBIE_SPAWN_EGG = register("dark_zombie_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.DARK_ZOMBIE.get(), -16751104, -13369549));
    public static final RegistrySupplier<Item> VORDUS_SPAWN_EGG = register("vordus_spawn_egg", () -> new SpawnEggBase(Episode.Goodbye, RainimatorEntities.VORDUS.get(), -13421773, -3355648));
    public static final RegistrySupplier<Item> WITHER_SHIELD_SPAWN_EGG = register("wither_shield_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.WITHER_SHIELD.get(), -16777216, -1));
    public static final RegistrySupplier<Item> SKELETON_SNOW_SPAWN_EGG = register("skeleton_snow_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.SKELETON_SNOW.get(), -1, -13369345));
    public static final RegistrySupplier<Item> ZOMBIES_PIGLIN_KING_SPAWN_EGG = register("zombies_piglin_king_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.ZOMBIE_PIGLIN_KING.get(), -39424, -256));
    public static final RegistrySupplier<Item> PIGLIN_KING_ZOMBIES_SPAWN_EGG = register("piglin_king_zombies_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.PIGLIN_KING_ZOMBIES.get(), -26368, -52));
    public static final RegistrySupplier<Item> PIGLIN_KING_ZOMBIE_SPAWN_EGG = register("piglin_king_zombie_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.PIGLIN_KING_ZOMBIE.get(), -256, -13108));
    public static final RegistrySupplier<Item> PIGLIN_COMMANDER_SPAWN_EGG = register("piglin_commander_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.PIGLIN_COMMANDER.get(), -52, -256));
    public static final RegistrySupplier<Item> NAEUS_KING_SPAWN_EGG = register("naeus_king_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.NAEUS_KING.get(), -6737152, -65536));
    public static final RegistrySupplier<Item> TUSK_SPAWN_EGG = register("tusk_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.TUSK.get(), -13159, -13108));
    public static final RegistrySupplier<Item> BROTS_SPAWN_EGG = register("brots_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.BROTS.get(), -3399168, -9175040));
    public static final RegistrySupplier<Item> ZOMBIE_PIGLIN_ART_SPAWN_EGG = register("zombie_piglin_art_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.ZOMBIE_PIGLIN_ART.get(), -1343393, -412045));
    public static final RegistrySupplier<Item> MUTATED_SPAWN_EGG = register("mutated_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.MUTATED.get(), -5134336, -16735132));
    public static final RegistrySupplier<Item> NAMTAR_SPAWN_EGG = register("namtar_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.NAMTAR.get(), -7274496, -12544));
    public static final RegistrySupplier<Item> AGETHA_SPAWN_EGG = register("agetha_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.AGETHA.get(), -6710887, -3381760));
    public static final RegistrySupplier<Item> TRICER_SPAWN_EGG = register("tricer_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.TRICER.get(), -3407872, -16777216));
    public static final RegistrySupplier<Item> BIG_UNDEAD_SKELETON_SPAWN_EGG = register("big_undead_skeleton_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.BIG_UNDEAD_SKELETON.get(), -10066330, -16777216));
    public static final RegistrySupplier<Item> ARCHER_SPAWN_EGG = register("archer_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.ARCHER.get(), -6710887, -16750951));
    public static final RegistrySupplier<Item> DARYLL_SPAWN_EGG = register("daryll_spawn_egg", () -> new SpawnEggBase(Episode.ColdAsIce, RainimatorEntities.DARYLL.get(), -6737152, -1));
    public static final RegistrySupplier<Item> NULL_LIKE_SPAWN_EGG = register("null_like_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.NULL_LIKE.get(), -1, -16777216));
    public static final RegistrySupplier<Item> GIGABONE_SPAWN_EGG = register("gigabone_spawn_egg", () -> new SpawnEggBase(Episode.WeAreTheDanger, RainimatorEntities.GIGABONE.get(), -10066330, -3355393));
    public static final RegistrySupplier<Item> KLAUS_SPAWN_EGG = register("klaus_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.KLAUS.get(), -10066432, -16764109));
    public static final RegistrySupplier<Item> KLAUS_2_SPAWN_EGG = register("klaus_2_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.KLAUS_2.get(), -6711040, -16751002));
    public static final RegistrySupplier<Item> KRALOS_SPAWN_EGG = register("kralos_spawn_egg", () -> new SpawnEggBase(Episode.None, RainimatorEntities.KRALOS.get(), -16777165, -6750157));
    public static final RegistrySupplier<Item> ARABELLA_SPAWN_EGG = register("arabella_spawn_egg", () -> new SpawnEggBase(Episode.ToTheVoid, RainimatorEntities.ARABELLA.get(), -3407668, -13369345));
    public static final RegistrySupplier<Item> AZALEA_SPAWN_EGG = register("azalea_spawn_egg", () -> new SpawnEggBase(Episode.PreachToTheChoir, RainimatorEntities.AZALEA.get(), -256, -16738048));
