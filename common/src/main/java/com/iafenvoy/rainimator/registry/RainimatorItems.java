...
public class RainimatorItems {
    ...
    //resources
    public static final RegistrySupplier<Item> RAW_RUBY = register("raw_ruby", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> RUBY = register("ruby", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> SUPER_RUBY = register("super_ruby", () -> new Item(new Item.Settings().fireproof().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> RAW_SAPPHIRE = register("raw_sapphire", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> SAPPHIRE = register("sapphire", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> SUPER_SAPPHIRE = register("super_sapphire", () -> new Item(new Item.Settings().fireproof().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> RAW_SUGILITE = register("raw_sugilite", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> SUGILITE = register("sugilite", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> SUPER_SUGILITE = register("super_sugilite", () -> new Item(new Item.Settings().fireproof().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> RAW_TOPAZ = register("raw_topaz", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> TOPAZ = register("topaz", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> SUPER_TOPAZ = register("super_topaz", () -> new Item(new Item.Settings().fireproof().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> BLUE_DIAMOND = register("blue_diamond", () -> new Item(new Item.Settings().rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> BLACK_IRON = register("black_iron", () -> new Item(new Item.Settings().rarity(Rarity.RARE).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> OBSIDIAN_NUGGET = register("obsidian_nugget", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> ARCANE_INGOT = register("arcane_ingot", () -> new Item(new Item.Settings().rarity(Rarity.RARE).arch$tab(RainimatorItemGroups.ITEM)));
    //tool
    ...
    public static final RegistrySupplier<Item> LASER_SWORD = register("laser_sword", () -> new SwordItem(ToolMaterialUtil.of(3000, 4.0F, 13.0F, 1, 18, RainimatorItems.SUPER_SAPPHIRE::get, () -> Items.ENDER_EYE), 3, -2.4F, new Item.Settings().arch$tab(RainimatorItemGroups.MAIN)));
    ...
    public static final RegistrySupplier<Item> HOT_IRON = register("hot_iron", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> HOT_GLOVES = register("hot_gloves", HotGlovesItem::new);
    public static final RegistrySupplier<Item> GEMSTONE_MIXTURE = register("gemstone_mixture", () -> new Item(new Item.Settings().maxCount(1).rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    ...
    public static final RegistrySupplier<Item> WITHER_BONE = register("wither_bone", () -> new Item(new Item.Settings().maxCount(16).fireproof().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> NETHERITE_WITHER_BONE = register("netherite_wither_bone", () -> new Item(new Item.Settings().maxCount(16).fireproof().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> MAGIC_STAR = register("magic_star", () -> new Item(new Item.Settings().maxDamage(5).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> ICE_HEART = register("ice_heart", () -> new Item(new Item.Settings().maxCount(1).fireproof().rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> WARRIOR_HEART = register("warrior_heart", () -> new Item(new Item.Settings().maxCount(1).fireproof().rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> ENDER_HEART = register("ender_heart", () -> new Item(new Item.Settings().maxCount(1).fireproof().rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> LIGHT_HEART = register("light_heart", () -> new Item(new Item.Settings().maxCount(1).fireproof().rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> ICED_HEART = register("iced_heart", () -> new Item(new Item.Settings().maxCount(1).rarity(Rarity.UNCOMMON).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> ZOMBIE_HEART = register("zombie_heart", ZombieHeartItem::new);
    public static final RegistrySupplier<Item> DIAMOND_PIECE = register("diamond_piece", () -> new Item(new Item.Settings().arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> BAO_ZHU = register("bao_zhu", () -> new Item(new Item.Settings().maxCount(32).rarity(Rarity.UNCOMMON).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> SOUL_PEOPLE = register("soul_people", () -> new Item(new Item.Settings().maxCount(32).rarity(Rarity.UNCOMMON).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> ENDER_STONE = register("ender_stone", () -> new Item(new Item.Settings().maxCount(1).fireproof().rarity(Rarity.UNCOMMON).arch$tab(RainimatorItemGroups.ITEM)));
    public static final RegistrySupplier<Item> NEAUS_SOULS = register("neaus_souls", () -> new Item(new Item.Settings().maxCount(32).fireproof().rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    ...
    public static final RegistrySupplier<Item> WITHER_TOKEN = register("wither_token", () -> new Item(new Item.Settings().maxCount(1).rarity(Rarity.EPIC).arch$tab(RainimatorItemGroups.ITEM)));
    ...
    public static final RegistrySupplier<Item> LIGHT_SWORD = register("light_sword", () -> new SwordItem(ToolMaterialUtil.of(200, 0.0F, 5.0F, 0, 25), 3, -2.2F, new Item.Settings().fireproof().arch$tab(RainimatorItemGroups.MAIN)));
    ...
    public static final RegistrySupplier<Item> RAIN_LASER_SWORD = register("rain_lazyed_sword", () -> new SwordItem(ToolMaterialUtil.of(1500, 0.0F, 8.0F, 0, 15), 3, -2.0F, new Item.Settings().arch$tab(RainimatorItemGroups.MAIN)));
    ...
    public static final RegistrySupplier<Item> ARCANE_BLADES = register("arcane_blades", () -> new SwordItem(ToolMaterialUtil.of(240, 4.0F, 4.0F, 1, 20), 3, -2.4F, new Item.Settings().arch$tab(RainimatorItemGroups.MAIN)));
    public static final RegistrySupplier<Item> DEAD_SCYTHE = register("dead_scythe", DeadScytheItem::new);
    public static final RegistrySupplier<Item> ENDER_CHESTPLATE = register("ender_chestplate", () -> new EnderArmorItem(ArmorItem.Type.CHESTPLATE));
    public static final RegistrySupplier<Item> ENDER_LEGGINGS = register("ender_leggings", () -> new EnderArmorItem(ArmorItem.Type.LEGGINGS));
    public static final RegistrySupplier<Item> ENDER_BOOTS = register("ender_boots", () -> new EnderArmorItem(ArmorItem.Type.BOOTS));
    //entity
