...
public class PiglinKingCrownModel<T extends Entity> extends EntityModel<T> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(RainimatorMod.MOD_ID, "modelnether_king_2"), "main");
    public final ModelPart head;

    public PiglinKingCrownModel(ModelPart root) {
