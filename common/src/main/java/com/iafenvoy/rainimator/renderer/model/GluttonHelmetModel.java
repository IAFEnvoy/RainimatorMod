...
public class GluttonHelmetModel<T extends Entity> extends EntityModel<T> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(RainimatorMod.MOD_ID, "model_custom_model"), "main");
    public final ModelPart head;

    public GluttonHelmetModel(ModelPart root) {
