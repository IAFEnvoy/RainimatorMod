...
public class PorkshireKingCrownModel<T extends Entity> extends EntityModel<T> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(RainimatorMod.MOD_ID, "model_porkshire_king_crown"), "main");
    public final ModelPart head;

    public PorkshireKingCrownModel(ModelPart root) {
