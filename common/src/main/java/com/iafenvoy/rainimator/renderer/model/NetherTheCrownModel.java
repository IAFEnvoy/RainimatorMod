...
public class NetherTheCrownModel<T extends Entity> extends EntityModel<T> {
    public static final EntityModelLayer LAYER_LOCATION = new EntityModelLayer(Identifier.of(RainimatorMod.MOD_ID, "modelnether_crown"), "main");
    public final ModelPart head;

    public NetherTheCrownModel(ModelPart root) {
