...
import com.rainimator.rainimatormod.model.Modelnether_king_2;
...
public class PiglinkingcrownItem extends ArmorItem {
    public PiglinkingcrownItem(EquipmentSlot slot, Item.Properties properties) {
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
        return RainimatorMod.MOD_ID + ":textures/entities/nether_king_3.png";
    }
        ...
        public void initializeClient(Consumer<IItemRenderProperties> consumer) {
            consumer.accept(new IItemRenderProperties() {
                public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
                    HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head", (new Modelnether_king_2(Minecraft.getInstance().getEntityModels().bakeLayer(Modelnether_king_2.LAYER_LOCATION))).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body", new ModelPart(
...
//        defaultModel){
//            HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head", (new Modelnether_king_2(Minecraft.getInstance().getEntityModels().bakeLayer(Modelnether_king_2.LAYER_LOCATION))).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_arm", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "right_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "left_leg", new ModelPart(Collections.emptyList(), Collections.emptyMap()))));
//            armorModel.crouching = living.isShiftKeyDown();
//            armorModel.riding = defaultModel.riding;
//            armorModel.young = living.isBaby();
//            return armorModel;
