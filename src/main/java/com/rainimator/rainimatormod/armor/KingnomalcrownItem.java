...
import com.rainimator.rainimatormod.model.Modelking_nomal_crown;
...
public class KingnomalcrownItem extends ArmorItem {
    public KingnomalcrownItem(EquipmentSlot slot, Item.Properties properties) {
    ...
    public static class Helmet extends KingnomalcrownItem {
        public Helmet() {
        ...
        public void initializeClient(Consumer<IItemRenderProperties> consumer) {
            consumer.accept(new IItemRenderProperties() {
                public HumanoidModel getArmorModel(LivingEntity living, ItemStack stack, EquipmentSlot slot, HumanoidModel defaultModel) {
                    HumanoidModel armorModel = new HumanoidModel(new ModelPart(Collections.emptyList(), Map.of("head", (new Modelking_nomal_crown(Minecraft.getInstance().getEntityModels().bakeLayer(Modelking_nomal_crown.LAYER_LOCATION))).Head, "hat", new ModelPart(Collections.emptyList(), Collections.emptyMap()), "body", new ModelPart(
