...
public class ModItems {
    ...
    public static final RegistryObject<Item> LASER_SWORD = REGISTRY.register("laser_sword", () -> new FoilSwordItemBase(TierBase.of(3000, 4.0F, 13.0F, 1, 18, ModItems.SUPER_SPPARIES.get(), Items.ENDER_EYE), 3, -2.4F, ModCreativeTab.createProperty()));
    ...
    public static final RegistryObject<Item> LIGHTSWORD = REGISTRY.register("lightsword", () -> new FoilSwordItemBase(TierBase.of(200, 0.0F, 5.0F, 0, 25), 3, -2.2F, ModCreativeTab.createProperty().fireResistant()));
    ...
    public static final RegistryObject<Item> RAINLAZYEDSWORD = REGISTRY.register("rainlazyedsword", () -> new FoilSwordItemBase(TierBase.of(1500, 0.0F, 8.0F, 0, 15), 3, -2.0F, ModCreativeTab.createProperty()));
    ...
    public static final RegistryObject<Item> NAEUS_SPAWN_EGG = REGISTRY.register("naeus_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.NAEUS, -10066330, -3355444, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> ABIGAIL_SPAWN_EGG = REGISTRY.register("abigail_spawn_egg", () -> new SpawnEggBase(Episode.TheStruggle,ModEntities.ABIGAIL, -65332, -39169, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> HOGSWORTH_SPAWN_EGG = REGISTRY.register("hogsworth_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.HOGSWORTH, -26215, -13108, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> HILDA_SPAWN_EGG = REGISTRY.register("hilda_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.HILDA, -256, -3355444, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> DARKSHIELD_SPAWN_EGG = REGISTRY.register("darkshield_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.DARKSHIELD, -6736897, -16777216, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> DARKZOMBIE_SPAWN_EGG = REGISTRY.register("darkzombie_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.DARKZOMBIE, -16751104, -13369549, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> VORDUS_SPAWN_EGG = REGISTRY.register("vordus_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.VORDUS, -13421773, -3355648, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> WITHERSHIELD_SPAWN_EGG = REGISTRY.register("withershield_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.WITHERSHIELD, -16777216, -1, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> SKELETONSNOW_SPAWN_EGG = REGISTRY.register("skeletonsnow_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.SKELETONSNOW, -1, -13369345, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> ZOMBIESPLIGEKING_SPAWN_EGG = REGISTRY.register("zombiespligeking_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.ZOMBIESPLIGEKING, -39424, -256, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> PILGEKINGZOMBIES_SPAWN_EGG = REGISTRY.register("pilgekingzombies_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.PILGEKINGZOMBIES, -26368, -52, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> PILGEKINGZOMBIE_SPAWN_EGG = REGISTRY.register("pilgekingzombie_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.PILGEKINGZOMBIE, -256, -13108, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> PIGLINCOMMANDER_SPAWN_EGG = REGISTRY.register("piglincommander_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.PIGLINCOMMANDER, -52, -256, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> NAEUSKING_SPAWN_EGG = REGISTRY.register("naeusking_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.NAEUSKING, -6737152, -65536, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> ZOMBIEPIGLINART_SPAWN_EGG = REGISTRY.register("zombiepiglinart_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.ZOMBIEPIGLINART, -1343393, -412045, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> BIGUNDEADSKELETON_SPAWN_EGG = REGISTRY.register("bigundeadskeleton_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.BIGUNDEADSKELETON, -10066330, -16777216, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> DARYLL_SPAWN_EGG = REGISTRY.register("daryll_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.DARYLL, -6737152, -1, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> NULLLIKE_SPAWN_EGG = REGISTRY.register("nulllike_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.NULLLIKE, -1, -16777216, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> GIGABONE_SPAWN_EGG = REGISTRY.register("gigabone_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.GIGABONE, -10066330, -3355393, ModCreativeTab.createProperty("mobs")));
    ...
    public static final RegistryObject<Item> ARABELLA_SPAWN_EGG = REGISTRY.register("arabella_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.ARABELLA, -3407668, -13369345, ModCreativeTab.createProperty("mobs")));
    public static final RegistryObject<Item> AZALEA_SPAWN_EGG = REGISTRY.register("azalea_spawn_egg", () -> new SpawnEggBase(Episode.None,ModEntities.AZALEA, -256, -16738048, ModCreativeTab.createProperty("mobs")));
    //music
