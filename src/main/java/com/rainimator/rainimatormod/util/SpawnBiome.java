...
public class SpawnBiome {
    //wtf is this?
    public static final Set<ResourceLocation> SPAWN_BIOMES = Set.of(
            ...
            new ResourceLocation("ice_spikes"),
            ...
            new ResourceLocation("bamboo_jungle"),
            ...
            new ResourceLocation("basalt_deltas"),
            ...
            new ResourceLocation("grove"),
            new ResourceLocation("old_growth_pine_taiga"),
            new ResourceLocation("beach"),
    ...
    public static final Set<ResourceLocation> SNOW_SPAWN_BIOMES = Set.of(
            new ResourceLocation("windswept_hills"),
            new ResourceLocation("snowy_plains"),
            new ResourceLocation("snowy_slopes"),
            new ResourceLocation("snowy_taiga"),
