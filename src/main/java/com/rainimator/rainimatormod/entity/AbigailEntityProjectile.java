...
public class AbigailEntityProjectile extends AbstractArrow implements ItemSupplier {
    public AbigailEntityProjectile(PlayMessages.SpawnEntity packet, Level world) {
        super(ModEntities.ABIGAIL_PROJECTILE.get(), world);
    }

    public AbigailEntityProjectile(EntityType<? extends AbigailEntityProjectile> type, Level world) {
        super(type, world);
    }
