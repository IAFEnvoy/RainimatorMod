...
public class CiaraEntityProjectile extends AbstractArrow implements ItemSupplier {
    public CiaraEntityProjectile(PlayMessages.SpawnEntity packet, Level world) {
        super(ModEntities.CIARA_PROJECTILE.get(), world);
    }

    public CiaraEntityProjectile(EntityType<? extends CiaraEntityProjectile> type, Level world) {
        super(type, world);
    }
