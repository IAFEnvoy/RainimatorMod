...
public class AzaleaEntity extends MonsterEntityBase {
    public static Stage.StagedEntityTextureProvider texture = Stage.ofProvider("azalea");

    public AzaleaEntity(PlayMessages.SpawnEntity packet, Level world) {
        this(ModEntities.AZALEA.get(), world);
    }
