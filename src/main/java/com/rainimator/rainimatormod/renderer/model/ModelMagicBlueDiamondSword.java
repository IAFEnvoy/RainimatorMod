...
public class ModelMagicBlueDiamondSword<T extends Entity> extends EntityModel<T> {
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(RainimatorMod.MOD_ID, "modelmagic_blue_diamond_sword"), "main");
